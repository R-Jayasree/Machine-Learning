...
This repository contains the code and report for a machine learning task that compares a basic Perceptron Learning Algorithm (PLA) with a Multilayer Perceptron (MLP) for character recognition. It also includes hyperparameter tuning to find the optimal configuration for the MLP.
...
**Files in this Repository**
  ...
  * `ml_ass5_report.pdf`: A detailed PDF report summarizing the project's aim, methodology, results, and conclusions.
